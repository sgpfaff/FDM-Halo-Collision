...
#Simulation
sim = Simulation(dt=0.25*u.Myr, eps=0.5*u.kpc)            
...
make_FDM_halo(init_values_1, [4000*u.pc, 4000*u.pc, 0*u.pc], [-150*u.km/u.s, 0*u.km/u.s, 0*u.km/u.s], "blue")
make_FDM_halo(init_values_2, [-4000*u.pc, -4000*u.pc, 0*u.pc],[150*u.km/u.s, 0*u.km/u.s, 0*u.km/u.s], "orange")
sim.run(400)
sim.movie_particles('DF.mp4', unit=u.kpc, fps=30, xlim=[-50,50], ylim=[-50,50])
